...
La ventana movil conserva el historial de CPU para reportes y consultas.
El detector compara la lectura actual con el umbral para que la alerta
coincida con el porcentaje visible en el dashboard.
""" 
