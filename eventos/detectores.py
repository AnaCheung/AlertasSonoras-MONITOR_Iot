...
def _cpu(lectura): 
    ...
    # La tarjeta muestra la lectura actual, por lo que el umbral debe usar
    # el mismo valor para que la alerta sonora coincida con lo visible.
    eventos += _histeresis("cpu", valor, config.CPU_ALTO,
