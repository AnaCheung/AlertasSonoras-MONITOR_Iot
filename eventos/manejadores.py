...
# LABORATORIO: mensajes para eventos de conexión; detectores originales intactos.
def red_desconectada(dato):
    return ("ALERTA", "Se perdió la conexión de red")

def red_conectada(dato):
    return ("INFO", "Se recuperó la conexión de red")

def red_sigue_desconectada(dato):
    return ("AVISO", "La red continúa desconectada")
